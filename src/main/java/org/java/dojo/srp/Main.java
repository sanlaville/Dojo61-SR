...
public class Main {
	...
	public static void main(String[] args) {
		...
		main.displayMailContentwithVisitor();
	}
	...
	private void displayMailContentwithVisitor() {
		
		IMailVisitor mailVisitor = new CartMailVisitor();
		cart.acceptMailVisitor(mailVisitor);
		logger.info(NEW_LINE + "********** Display MailContent - Method 2: use of pattern Visitor **********" + NEW_LINE + mailVisitor.computeMailContent());
	}
